        ...
        <div className="glass p-8 rounded-2xl shadow-modern border border-border/20 max-w-2xl mx-auto">
          <div className="flex justify-center items-center gap-3 mb-6">
            ...
            <img 
              ...
              className="h-24 w-auto flex-shrink-0 max-w-none"
            />
          </div>
          ...
          <div className="space-y-3 text-muted-foreground font-outfit">
            ...
            <div className="flex justify-center gap-6 py-4">
              <a 
                href="https://www.instagram.com/comproseuveiculo/" 
                target="_blank" 
              ...
              <a 
                href="https://www.facebook.com/zr8comproseuveiculo" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
              >
              ...
              <a 
                href="https://api.whatsapp.com/send/?phone=5551980104004&text&type=phone_number&app_absent=0" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
              >
